...
const Footer = async () => {
    const repoStats = await fetch(
        'https://api.github.com/repos/Kunal/portfolio-2.0',
        {
            next: {
    ...
    return (
        <footer className="text-center pb-5 z-1000 relative" id="contact">
            <div className="container z-1000 relative">
                ...
                <div className="">
                    <a
                        href="https://github.com/Kunal/portfolio-2.0"
                        target="_blank"
                        className="leading-none text-muted-foreground hover:underline hover:text-white"
                    >
                        Design & built by Kunal Ghosh
