...
Yes, you can fork this repo. Please give me proper credit by linking back to [Kunal.site](https://Kunal.site/). Thanks!
...
## 📄 License
This project is open source and available under the [MIT License](https://github.com/Kunal/portfolio-2.0/blob/main/LICENSE).
